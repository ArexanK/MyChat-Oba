...
// // welcome current user (messages)
// socket.emit('message', formatMessage(botName, 'Welcome to Chat Oba'))

// //broadcast when a user connects
// socket.broadcast.emit('message', 'Arexan joined the chat')


// //Broadcast when a user disconnects
// socket.on('disconnect', () => {
//             io.emit('message', 'Arexan left the chat');
//         }
